...
p?"00"+p:"0"+p:p;break;case "k":h=l;break;case "l":h=m;break;case "m":h=9>d?"0"+(1+d):1+d;break;case "M":h=10>n?"0"+n:n;break;case "p":case "P":h=k?"PM":"AM";break;case "s":h=Math.floor(a.getTime()/1E3);break;case "S":h=10>r?"0"+r:r;break;case "u":h=f+1;break;case "w":h=f;break;case "y":h=(""+g).substr(2,2);break;case "Y":h=g}b[q]=h}return b.join("")}function O(a,b){var c=a.__pickmeup.options,d;x(b);a:{var e;switch(c.mode){case "multiple":e=b.valueOf();for(d=0;d<c.date.length;++d)if(c.date[d].valueOf()===
