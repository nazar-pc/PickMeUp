...
1],b.current=c?new Date(c):new Date);b.current.setDate(1);b.bound.fill();C(a,"input")&&!1!==b.default_date&&(c=H(b),d=a.value,b="single"==b.mode?c.formatted_date:c.formatted_date.join(b.separator),d||D(a.__pickmeup.element,"change",c),d!=b&&(a.value=b))}function X(a){var d=a.__pickmeup.element;z(a);y(d);delete a.__pickmeup}function L(a,d,c){return d&&d>a?new Date(d):c&&c<a?new Date(c):a}function F(a,d){"string"==typeof a&&(a=document.querySelector(a));if(!a.__pickmeup){var c,b={};d=d||{};for(c in F.defaults)b[c]=
