...
break;case "range":b.lastSel||(b.date[0]=d);d<=b.date[0]?(b.date[1]=b.date[0],b.date[0]=d):b.date[1]=d;b.lastSel=!b.lastSel;break;default:b.date=d.valueOf()}}d=H(b);C(a,"input")&&(a.value="single"==b.mode?d.formatted_date:d.formatted_date.join(b.separator));D(c,"change",d);if(!b.flat&&b.hide_on_select&&("range"!=b.mode||!b.lastSel))return b.bound.hide(),!1}function P(a,d){d=d.target;n(d,"pmu-button")||(d=J(d,".pmu-button"));if(!n(d,"pmu-button")||n(d,"pmu-disabled"))return!1;a=a.__pickmeup.options;
var c=J(d,".pmu-instance"),b=c.parentElement,c=Array.prototype.slice.call(b.querySelectorAll(".pmu-instance")).indexOf(c);C(d.parentElement,"nav")?n(d,"pmu-month")?(r(a.current,c-Math.floor(a.calendars/2)),n(b,"pmu-view-years")?(a.current="single"!=a.mode?new Date(a.date[a.date.length-1]):new Date(a.date),a.select_day?(b.classList.remove("pmu-view-years"),l(b,"pmu-view-days")):a.select_month&&(b.classList.remove("pmu-view-years"),l(b,"pmu-view-months"))):n(b,"pmu-view-months")?a.select_year?(b.classList.remove("pmu-view-months"),
