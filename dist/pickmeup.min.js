...
if(1<d.length)return d.forEach(function(a,c,d){d[c]=u(a.trim(),b)}),d;d=[].concat(e.daysShort,e.daysMin,e.days,e.monthsShort,e.months);d=d.map(function(a){return"("+a+")"});d=new RegExp("[^0-9"+d+"]+");a=a.split(d);for(var d=c.split(d),g,f,l,k,m,p=new Date,c=0;c<a.length;c++)switch(d[c]){case "b":f=e.monthsShort.indexOf(a[c]);break;case "B":f=e.months.indexOf(a[c]);break;case "d":case "e":g=parseInt(a[c],10);break;case "m":f=parseInt(a[c],10)-1;break;case "Y":case "y":l=parseInt(a[c],10);l+=100<l?
0:29>l?2E3:1900;break;case "H":case "I":case "k":case "l":k=parseInt(a[c],10);break;case "P":case "p":/pm/i.test(a[c])&&12>k?k+=12:/am/i.test(a[c])&&12<=k&&(k-=12);break;case "M":m=parseInt(a[c],10)}e=new Date(void 0===l?p.getFullYear():l,void 0===f?p.getMonth():f,void 0===g?p.getDate():g,void 0===k?p.getHours():k,void 0===m?p.getMinutes():m,0);isNaN(1*e)&&(e=new Date);return x(e)}function x(a){a.setHours(0,0,0,0);return a}function D(a,b,c){var d=a.getMonth(),e=a.getDate(),g=a.getFullYear(),f=a.getDay(),
l=a.getHours(),k=12<=l,m=k?l-12:l,p;p=new Date(a.getFullYear(),a.getMonth(),a.getDate(),0,0,0);var n=new Date(a.getFullYear(),0,0,0,0,0);p=Math.floor((p-n)/24*36E5);0==m&&(m=12);var n=a.getMinutes(),r=a.getSeconds();b=b.split("");for(var h,q=0;q<b.length;q++){h=b[q];switch(h){case "a":h=c.daysShort[f];break;case "A":h=c.days[f];break;case "b":h=c.monthsShort[d];break;case "B":h=c.months[d];break;case "C":h=1+Math.floor(g/100);break;case "d":h=10>e?"0"+e:e;break;case "e":h=e;break;case "H":h=10>l?
"0"+l:l;break;case "I":h=10>m?"0"+m:m;break;case "j":h=100>p?10>p?"00"+p:"0"+p:p;break;case "k":h=l;break;case "l":h=m;break;case "m":h=9>d?"0"+(1+d):1+d;break;case "M":h=10>n?"0"+n:n;break;case "p":case "P":h=k?"PM":"AM";break;case "s":h=Math.floor(a.getTime()/1E3);break;case "S":h=10>r?"0"+r:r;break;case "u":h=f+1;break;case "w":h=f;break;case "y":h=(""+g).substr(2,2);break;case "Y":h=g}b[q]=h}return b.join("")}function O(a,b){var c=a.__pickmeup.options,d;x(b);a:{var e;switch(c.mode){case "multiple":e=
